...
<div id="wrapper" class="clearfix">
    ...
    <div class="main-content">
                        ...
                        <ul>
                            ...
                            <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="storage/images/bg/bg1.jpg" data-rotate="0"  data-fstransition="fade" data-saveperformance="off" data-title="Web Show" data-description="">
                                ...
                                <div class="tp-caption tp-resizeme rs-parallaxlevel-0 text-white text-uppercase font-roboto-slab font-weight-700"
                                     ...
                                     data-splitout="none"
                                     data-responsive_offset="on"
                                     style="z-index: 5; white-space: nowrap; font-weight:700;">Information Technology Student Union
                            ...
                            <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="storage/images/bg/bg2.jpg" data-rotate="0"  data-fstransition="fade" data-saveperformance="off" data-title="Web Show" data-description="">
                                ...
                                <div class="tp-caption tp-resizeme rs-parallaxlevel-0 text-white text-uppercase font-roboto-slab font-weight-700"
                                     ...
                                     data-splitout="none"
                                     data-responsive_offset="on"
                                     style="z-index: 5; white-space: nowrap; font-weight:700;">Welcome To<span class="text-theme-colored2"> ITSU</span>
                                </div>
                            ...
                            <li data-index="rs-3" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="storage/images/bg/bg3.jpg" data-rotate="0"  data-fstransition="fade" data-saveperformance="off" data-title="Web Show" data-description="">
                                ...
                                <div class="tp-caption tp-resizeme rs-parallaxlevel-0 text-white text-uppercase font-roboto-slab font-weight-700"
                                     ...
                                     data-splitout="none"
                                     data-responsive_offset="on"
                                     style="z-index: 5; white-space: nowrap; font-weight:700;">Leading<span class="text-theme-colored2"> Department</span>
                                </div>
                            </li>
                        </ul>
                        ...
                        <div class="col-sm-12 col-md-3 pl-0 pl-sm-15 pr-0 pr-sm-15 sm-height-auto mt-sm-0 wow fadeInLeft animation-delay1">
                            <div class="sm-height-auto" data-bg-color="#5D9CEC">
                                <div class="features-box-colored text-center p-15 pt-30 pb-20">
                                    ...
                                    <h4 class="text-uppercase font-weight-600 mt-0"><a href="#" class="text-white">Newly Offered Programs</a></h4>
                                    <p class="text-white">
                                    <ul class="list text-white angle-double-right">
                                        <li class="text-white">Diploma in Networking</li>
                                        <li>Diploma in Software Engineering</li>
                                        <li>Diploam in Information Technology</li>
                                    </ul>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-3 pl-0 pl-sm-15 pr-0 pr-sm-15 sm-height-auto mt-sm-0 wow fadeInLeft animation-delay2">
                            <div class="sm-height-auto" data-bg-color="#EF5861">
                                <div class="features-box-colored text-center p-15 pt-30 pb-20">
                                    ...
                                    <h4 class="text-uppercase font-weight-600 mt-0"><a href="/pastQuestion" class="text-white">Past Question</a></h4>
                                    <p class="text-white">
                                        Get All Past Question Here
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-3 pl-0 pl-sm-15 pr-0 pr-sm-15 sm-height-auto mt-sm-0 wow fadeInLeft animation-delay3">
                            <div class="sm-height-auto" data-bg-color="#E79800">
                                <div class="features-box-colored text-center p-15 pt-30 pb-20">
                                    ...
                                    <h4 class="text-uppercase font-weight-600 mt-0"><a href="#" class="text-white">Semester Time Table</a></h4>
                                    <p class="text-white">Click to Download Semester Time Table</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-3 pl-0 pl-sm-15 pr-0 pr-sm-15 sm-height-auto mt-sm-0 wow fadeInLeft animation-delay4">
                            <div class="sm-height-auto" data-bg-color="#43B14B">
                                <div class="features-box-colored text-center p-15 pt-30 pb-20">
                                    ...
                                    <h4 class="text-uppercase font-weight-600 mt-0"><a href="#" class="text-white">Certification</a></h4>
        ...
        <section id="latest-news" class="bg-silver-deep">
                            ...
                            <div class="owl-carousel-2col owl-nav-top" data-nav="true">
                                    ...
                                    <article class="post clearfix mb-30">
                                        <div class="entry-header">
                                            <div class="post-thumb thumb">
                                                <img src="{{'storage/images/serminar.jpg'}}" alt="" class="img-responsive img-fullwidth">
                                            </div>
                                            ...
                                            <div class="entry-meta media no-bg no-border mt-0 mb-10">
                                                <div class="media-body pl-0">
                                                    <div class="event-content pull-left flip">
                                                        <h4 class="entry-title text-white text-uppercase font-weight-600 m-0 mt-5"><a href="blog-single-left-sidebar.html">Practical Seminar</a></h4>
                                                        <ul class="list-inline">
                                                            <li><i class="fa fa-thumbs-o-up mr-5 text-theme-colored2"></i>Signed ICT President</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <p class="mt-5">The Executives of the union is preparing to change Departmental seminar's into Practical to enable student to have a feel of the practical aspect of ICT instead of reading books always</p>
                                ...
                                <div class="item">
                                    <article class="post clearfix mb-30">
                                        <div class="entry-header">
                                            <div class="post-thumb thumb">
                                                <img src="{{'storage/images/technology.jpg'}}" alt="" class="img-responsive img-fullwidth">
                                            </div>
                                            <div class="entry-date media-left text-center flip bg-theme-colored border-top-theme-colored2-3px pt-5 pr-15 pb-5 pl-15">
                                                <ul>
                                        ...
                                        <div class="entry-content bg-white p-15">
                                            <div class="entry-meta media no-bg no-border mt-0 mb-10">
                                                <div class="media-body pl-0">
                                                    <div class="event-content pull-left flip">
                                                        <h4 class="entry-title text-white text-uppercase font-weight-600 m-0 mt-5"><a href="blog-single-left-sidebar.html">Technological Fair</a></h4>
                                                        <ul class="list-inline">
                                                            <li><i class="fa fa-thumbs-o-up mr-5 text-theme-colored2"></i>Signed ICT President</li>
                                                        </ul>
                                                    </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <article>
                                <div class="event-small media sm-maxwidth400 mt-0 mb-0 pt-0 pb-15">
                                    ...
                                    <div class="event-content pt-5">
                                        <h5 class="media-heading font-16 font-weight-600 mb-5"><a href="#">Technological Fair</a></h5>
                                        <span class="mr-10"><i class="fa fa-clock-o text-theme-colored2"></i> 8:00 am - 3:00 pm</span>
                                        <span> <i class="fa fa-map-marker text-theme-colored2"></i> University Auditorium</span>
                                    </div>
                                </div>
                            </article>
                            <article>
        ...
        <section id="upcoming-event">
            <div class="container pt-50 pb-40">
                <div class="section-title">
                    <div class="row">
                        <div class="col-md-4">
                            <h3 class="text-uppercase text-theme-colored2 font-weight-600 mt-0">About <span class="text-theme-colored">ITSU</span></h3>
                            <div class="double-line-bottom-theme-colored-2"></div>
                            ...
                            <a href="/about-us" class="btn btn-colored btn-theme-colored2 text-white btn-lg pl-40 pr-40 mt-10">Read More</a>
                        </div>
                        <div class="col-md-4">
        ...
        <section class="parallax layer-overlay overlay-theme-colored-9" data-bg-img="storage/images/bg/bg1.jpg" data-parallax-ratio="0.4">
            <div class="container pt-90 pb-90">
                <div class="section-content">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
                            <div class="funfact text-center">
                                <div class="odometer-animate-number text-white font-weight-600 font-48" data-value="5" data-theme="minimal">0</div>
                                <div class="double-line-bottom-centered-theme-colored-2 mt-0 mb-25"></div>
        ...
        <section id="academic-calendar" class="parallax Divider layer-overlay overlay-theme-colored-9" data-bg-img="storage/images/bg/bg7.jpg" data-parallax-ratio="0.4">
            <div class="container pt-70 pb-30">
                <div class="section-title">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="text-uppercase text-white title">Academic Calendar</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <h3 class="text-uppercase text-white font-weight-600 mt-0">Department <span class="text-theme-colored">ITSU</span></h3>
                        <div class="double-line-bottom-theme-colored-2"></div>
                        <iframe src="https://calendar.google.com/calendar/embed?showTitle=0&amp;showNav=0&amp;showDate=0&amp;showPrint=0&amp;showTabs=0&amp;showCalendars=0&amp;showTz=0&amp;height=500&amp;wkst=1&amp;bgcolor=%23FFFFFF&amp;src=b64pov0jbsnvcp2qetbg25mqes%40group.calendar.google.com&amp;color=%2342104A&amp;ctz=Africa%2FAccra" style="border-width:0" width="500" height="400" frameborder="0" scrolling="no"></iframe>
                    </div>
                    <div class="col-md-5">
                        <h3 class="text-uppercase text-white font-weight-600 mt-0">School <span class="text-theme-colored">ITSU</span></h3>
                        <div class="double-line-bottom-theme-colored-2"></div>
                        <iframe src="https://calendar.google.com/calendar/embed?showTitle=0&amp;showNav=0&amp;showDate=0&amp;showPrint=0&amp;showTabs=0&amp;showCalendars=0&amp;showTz=0&amp;height=500&amp;wkst=1&amp;bgcolor=%23FFFFFF&amp;src=b64pov0jbsnvcp2qetbg25mqes%40group.calendar.google.com&amp;color=%2342104A&amp;ctz=Africa%2FAccra" style="border-width:0" width="500" height="400" frameborder="0" scrolling="no"></iframe>
                    </div>
                </div>
                ...
                <div class="section-content">
                    <div class="row">
                                    ...
                                    <div class="panel-heading" role="tab" id="headin1">
                                        <h6 class="panel-title">
                                            <a role="button" data-toggle="collapse" data-parent="#accordion6" href="#collaps1" aria-expanded="true" aria-controls="collaps1">
                                                Why do I need to register my courses every semester?
                                            </a>
                                        </h6>
                                    </div>
                                    <div id="collaps1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headin1">
                                        <div class="panel-body">
                                            When you register your course, it also add you to your department, which means without registration, you are not a student of that program and the department as whole for that particular semester.
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="heading2">
                                        <h6 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion6" href="#collapse2" aria-expanded="false" aria-controls="collapse2">
                                                What is the need of industrial attachment?
                                            </a>
                                        </h6>
                                    </div>
                                    <div id="collapse2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading2">
                                        <div class="panel-body">
                                            Industrial Attachment helps student to gain hands-on training in their field of study. Most of the things learnt in class are very much different as to how it is been done in the industries.
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="heading3">
                                        <h6 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion6" href="#collapse3" aria-expanded="false" aria-controls="collapse3">
                                                Why should I assess my lectures every Semester?
                                            </a>
                                        </h6>
                                    </div>
                                    <div id="collapse3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading3">
                                        <div class="panel-body">
                                            Lectures is mandatory because, it gives management clear knowledge as to how each and every deals with his or her student.
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                        ...
                        <div class="col-md-7">
                                ...
                                <!-- Portfolio Item Start -->
                                    ...
                                    @foreach($newData as $dat)
                                        <div class="gallery-item">
                                            <div class="thumb">
                                                <img alt="project" src="{{asset('storage/images/gallery/handingOver/'.$dat)}}" class="img-fullwidth">
                                                <div class="overlay-shade"></div>
                                                <div class="icons-holder">
                                                    <div class="icons-holder-inner">
                                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                            <a href="{{asset('storage/images/gallery/handingOver/'.$dat)}}"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <a href="/gallery" class="btn  btn-danger">More</a>
                        </div>
                    </div>
                </div>
            </div>
